...
const PopupWithForm = ({
  ...
  return (
    <div className={`modal__section modal__section_${name}`} onClick={handleOuterClick}>
      <div className={`modal__content modal__content_${name}`}>
        <button className={`modal__button-reset modal__button-reset_${name}`} type="button" onClick={onClose}>
